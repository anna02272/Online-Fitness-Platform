...
nativeLanguage ENUM('SERBIAN','ENGLISH','GERMIAN','ITALIAN','FRENCH','RUSSIAN') NOT NULL,
...
speaksLangague ENUM('SERBIAN','ENGLISH','GERMIAN','ITALIAN','FRENCH','RUSSIAN') NOT NULL,
